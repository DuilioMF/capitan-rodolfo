...
title Reparar Capitan Rodolfo v67
...
if not "%V%"=="67" (
  echo ERROR: esperaba VERSION 67 y llego "%V%".
  goto :error
)

echo [4/4] Iniciando Capitan Rodolfo v67...
start "" "%APPROOT%\INICIAR_CAPITAN_RODOLFO.bat"

echo.
echo OK. Capitan Rodolfo v67 fue reparado e iniciado.
