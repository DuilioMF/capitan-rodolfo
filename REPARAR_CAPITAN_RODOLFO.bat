...
title Reparar Capitan Rodolfo v69
...
if not "%V%"=="69" (
  echo ERROR: esperaba VERSION 69 y llego "%V%".
  goto :error
)

echo [4/4] Iniciando Capitan Rodolfo v69...
start "" "%APPROOT%\INICIAR_CAPITAN_RODOLFO.bat"

echo.
echo OK. Capitan Rodolfo v69 fue reparado e iniciado.
