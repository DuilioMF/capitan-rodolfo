...
title Reparar Capitan Rodolfo v83
...
if not "%V%"=="83" (
  echo ERROR: esperaba VERSION 83 y llego "%V%".
  goto :error
)

echo [4/4] Iniciando Capitan Rodolfo v83...
start "" "%APPROOT%\INICIAR_CAPITAN_RODOLFO.bat"

echo.
echo OK. Capitan Rodolfo v83 fue reparado e iniciado.
