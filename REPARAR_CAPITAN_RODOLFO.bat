...
title Reparar Capitan Rodolfo v68
...
if not "%V%"=="68" (
  echo ERROR: esperaba VERSION 68 y llego "%V%".
  goto :error
)

echo [4/4] Iniciando Capitan Rodolfo v68...
start "" "%APPROOT%\INICIAR_CAPITAN_RODOLFO.bat"

echo.
echo OK. Capitan Rodolfo v68 fue reparado e iniciado.
