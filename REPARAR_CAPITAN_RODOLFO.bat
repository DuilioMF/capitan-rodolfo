...
title Reparar Capitan Rodolfo v75
...
if not "%V%"=="75" (
  echo ERROR: esperaba VERSION 75 y llego "%V%".
  goto :error
)

echo [4/4] Iniciando Capitan Rodolfo v75...
start "" "%APPROOT%\INICIAR_CAPITAN_RODOLFO.bat"

echo.
echo OK. Capitan Rodolfo v75 fue reparado e iniciado.
