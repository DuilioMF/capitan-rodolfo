...
title Reparar Capitan Rodolfo v81
...
if not "%V%"=="81" (
  echo ERROR: esperaba VERSION 81 y llego "%V%".
  goto :error
)

echo [4/4] Iniciando Capitan Rodolfo v81...
start "" "%APPROOT%\INICIAR_CAPITAN_RODOLFO.bat"

echo.
echo OK. Capitan Rodolfo v81 fue reparado e iniciado.
