...
title Reparar Capitan Rodolfo v74
...
if not "%V%"=="74" (
  echo ERROR: esperaba VERSION 74 y llego "%V%".
  goto :error
)

echo [4/4] Iniciando Capitan Rodolfo v74...
start "" "%APPROOT%\INICIAR_CAPITAN_RODOLFO.bat"

echo.
echo OK. Capitan Rodolfo v74 fue reparado e iniciado.
