...
title Reparar Capitan Rodolfo v84
...
if not "%V%"=="84" (
  echo ERROR: esperaba VERSION 84 y llego "%V%".
  goto :error
)

echo [4/4] Iniciando Capitan Rodolfo v84...
start "" "%APPROOT%\INICIAR_CAPITAN_RODOLFO.bat"

echo.
echo OK. Capitan Rodolfo v84 fue reparado e iniciado.
