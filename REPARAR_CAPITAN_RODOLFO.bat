...
title Reparar Capitan Rodolfo v73
...
if not "%V%"=="73" (
  echo ERROR: esperaba VERSION 73 y llego "%V%".
  goto :error
)

echo [4/4] Iniciando Capitan Rodolfo v73...
start "" "%APPROOT%\INICIAR_CAPITAN_RODOLFO.bat"

echo.
echo OK. Capitan Rodolfo v73 fue reparado e iniciado.
