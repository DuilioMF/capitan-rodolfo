/*
CAPITAN RODOLFO - INSTALADOR INICIAL PARA ADMINISTRADOR DE SiSRL.
Ejecutar una sola vez con cuenta que pueda ALTER PROCEDURE y GRANT.
No altera ni borra datos comerciales, pero sí instala/actualiza este SP.
Otorga solo EXECUTE al usuario de base 'dui' si ese principal existe.
Si tu usuario está mapeado con otro nombre, cambiar @UsuarioBD más abajo.
NO ejecutar con el usuario de la aplicación si no tiene permisos.
*/
